...
android {
    namespace = "com.thiruttaniquick.admin"
    compileSdk = 36
        ...
        create("release") {
            if (!keystorePropertiesFile.exists()) {
                throw GradleException(
                    ...
                    "Copy 'key.properties.template' to 'key.properties' in android/ and fill in:\n" +
                    "  storePassword=ThiruttaniKey2024\n" +
                    "  keyPassword=ThiruttaniKey2024\n" +
                    "  keyAlias=upload\n" +
    ...
    defaultConfig {
        applicationId = "com.thiruttaniquick.admin"
